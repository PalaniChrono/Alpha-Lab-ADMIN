...
export class OrganizationComponent implements OnInit {
  ...
  index() {
      this.loading = true;
      this.apiService.index('getAllOrganization').subscribe(data => {
  ...
  store() {
      ...
      this.apiCall('store', 'Organization');
  }

  show(id) {
      this.apiService.show('Organization/' + id).subscribe((data) => {
  ...
  update(id) {
      this.loadingBtn = true;
      this.apiCall('update', 'Organization/' + id);
  }
  ...
  bannerSwitch(id) {
      this.apiCall('getData', 'OrganizationSwitch/' + id);
  }
  ...
  swalCall(id) {
      Swal.fire({
          ...
          if (result.value) {
              this.apiCall('destroy', 'Organization/' + id);
              Swal.fire(
                  'Deleted!',
