...
@Component({
  selector: 'app-who-we-are-image',
  templateUrl: './who-we-are-image.component.html',
  styleUrls: ['./who-we-are-image.component.css']
})
export class WhoWeAreImageComponent implements OnInit {
  ...
  imageUpdateBanner(imageFile) {
      ...
      this.apiService.postData(formData, 'imageUpdateWhoWeAre').subscribe(data => {
      if (data.error === false) {
