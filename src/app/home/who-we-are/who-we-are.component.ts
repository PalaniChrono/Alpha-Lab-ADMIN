...
export class WhoWeAreComponent implements OnInit {
  ...
  index() {
      this.loading = true;
      this.apiService.index('getAllWhoWeAre').subscribe(data => {
  ...
  store() {
      ...
      this.apiCall('store', 'WhoWeAre');
  }

  show(id) {
      this.apiService.show('WhoWeAre/' + id).subscribe((data) => {
  ...
  update(id) {
      this.loadingBtn = true;
      this.apiCall('update', 'WhoWeAre/' + id);
  }
  ...
  bannerSwitch(id) {
      this.apiCall('getData', 'WhoWeAreSwitch/' + id);
  }
  ...
  swalCall(id) {
      Swal.fire({
          ...
          if (result.value) {
              this.apiCall('destroy', 'WhoWeAre/' + id);
              Swal.fire(
                  'Deleted!',
