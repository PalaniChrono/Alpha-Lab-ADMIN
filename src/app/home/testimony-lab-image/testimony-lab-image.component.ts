...
@Component({
  selector: 'app-testimony-lab-image',
  templateUrl: './testimony-lab-image.component.html',
  styleUrls: ['./testimony-lab-image.component.css']
})
export class TestimonyLabImageComponent implements OnInit {
  ...
  imageUpdateBanner(imageFile) {
      ...
      this.apiService.postData(formData, 'imageUpdateTestimonyLab').subscribe(data => {
      if (data.error === false) {
          this.toastr.success(data.message);
          this.router.navigate(['/testimony-Lab']);
      } else {
